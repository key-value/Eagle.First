...
namespace Eagle.Infrastructrue.Aop
{
    ...
    class MvcPerRequestLifetimeManager : LifetimeManager
    {
        #region Private Fields
        private readonly Guid key = Guid.NewGuid();
        #endregion

        public MvcPerRequestLifetimeManager() : this(Guid.NewGuid()) { }

        MvcPerRequestLifetimeManager(Guid key)
        {
            if (key == Guid.Empty)
